...
public class CFTCPart45InterestRateSwapNewTradeGenerator {
    ...
    void createReportableEventAndRunReport(String inputFilePath) {
        ...
        System.out.println("Auto-detecting CDM file type and extracting TradeState...");
        
        // Smart auto-detection and extraction of TradeState
        TradeState tradeState;
        try {
            tradeState = loadTradeStateFromAnyFile(inputFilePath);
        } catch (Exception e) {
        ...
        System.out.println("TradeState toString: " + tradeState.toString());
